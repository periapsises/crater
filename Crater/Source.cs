...
public class Source(int startLine, int startColumn, int stopLine, int stopColumn)
{
    ...
    public static Source FromToken(IToken token)
    {
        ...
        return new Source(startLine, startColumn, startLine, stopColumn);
    }
    
    public static Source FromContext(ParserRuleContext context)
    {
        return new Source(context.Start.Line, context.Start.Column, context.Stop.Line, context.Stop.Column);
    }
}
